...
const SEARCH_DEFINITIONS: SearchDefinition[] = [
  ...
  ["voice", "settings-tts", "settings.ttsRealtime", "tts realtime streaming потоковая озвучка"],
  ["voice", "settings-tts", "settings.ttsEndpoint", "tts url endpoint адрес"],
  ["voice", "settings-tts", "settings.apiKey", "tts api key ключ озвучки"],
  ["voice", "settings-tts", "settings.ttsAdapterId", "tts adapter адаптер"],
  ["voice", "settings-tts", "settings.ttsModel", "tts model модель озвучки"],
  ["voice", "settings-tts", "settings.ttsVoice", "tts voice голос"],
  ["voice", "settings-tts", "localModels.bundledTtsTitle", "bundled local teratts встроенная локальная озвучка установить скачать"],
  ["voice", "settings-stt", "settings.sttSource", "stt whisper source распознавание источник"],
  ["voice", "settings-stt", "settings.sttEndpoint", "stt whisper endpoint url адрес"],
  ["voice", "settings-stt", "settings.apiKey", "stt whisper api key ключ распознавания"],
  ["voice", "settings-stt", "settings.sttModel", "stt whisper model модель"],
  ["voice", "settings-stt", "settings.sttLanguage", "stt language язык распознавания"],
  ...
  ["generation", "settings-runtime-tuning", "settings.endpointDiscoveryTimeout", "model voice endpoint discovery timeout поиск моделей голосов таймаут"],
  ["generation", "settings-runtime-tuning", "settings.speechTranscriptionTimeout", "stt whisper transcription timeout распознавание речи таймаут"],
