...
const SEARCH_DEFINITIONS: SearchDefinition[] = [
  ...
  ["connection", "settings-tts", "localModels.bundledTtsTitle", "bundled local teratts встроенная локальная озвучка установить скачать"],
  ...
  ["connection", "settings-stt", "localModels.bundledSttTitle", "bundled local whisper встроенное локальное распознавание установить скачать"],
