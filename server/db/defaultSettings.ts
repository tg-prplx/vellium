...
export const DEFAULT_SETTINGS = {
  ...
  samplerConfig: {
    ...
    llamaCppDynatempRange: 0,
    llamaCppDynatempExponent: 1,
    llamaCppTopNSigma: -1,
    llamaCppXtcProbability: 0,
    llamaCppXtcThreshold: 0.1,
    llamaCppRepeatLastN: 64,
    llamaCppDryMultiplier: 0,
    llamaCppDryBase: 1.75,
    llamaCppDryAllowedLength: 2,
    llamaCppDryPenaltyLastN: 64,
    llamaCppDrySequenceBreakers: ["\n", ":", "\"", "*"],
    llamaCppMirostat: 0 as 0 | 1 | 2,
    llamaCppMirostatTau: 5,
    llamaCppMirostatEta: 0.1,
    llamaCppSeed: -1,
    llamaCppIgnoreEos: false,
    llamaCppMinKeep: 0,
    llamaCppReasoningEffort: "default" as const,
    llamaCppReasoningFormat: "auto" as const,
